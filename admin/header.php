...
<head>
    ...
    <title>Dashboard - Admin LAs Fresas de Sor Juana</title>
...
<body class="sb-nav-fixed" id="bod">
    <nav class="sb-topnav navbar navbar-expand" id="barraNav">
        ...
        <!-- Navbar Brand-->
        <img src="<?php echo ADMIN_URL; ?>images/icon.png" alt="" width="55" height="40" class="d-inline-block align-text-top">
        <a class="navbar-brand ps-1" href="<?php echo ADMIN_URL;?>inicio.php">Administración Las Fresas de Sor Juana</a>
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        <div class="sb-sidenav-menu-heading text-light">Las Fresas de Sor Juana</div>
