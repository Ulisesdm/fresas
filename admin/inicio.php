  ...
  .card-img-top {
    ...
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4 text-black">Las Fresas de Sor Juana</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Bienvenido al panel de Administrador Las Fresas de Sor Juana</li>
            </ol>
            <div class="row">
